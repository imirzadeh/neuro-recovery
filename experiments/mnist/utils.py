...
def parse_arguments():
	...
	parser.add_argument('--epochs', default=250000, type=int,  help='number of total epochs to run')
	parser.add_argument('--log_every', default=10000, type=int,  help='number of total epochs to run')
